...
def runSEIRS(S, E, I_pre, I_asym, I_sym, H, F, R, Q_E, Q_I_pre, Q_I_asym, Q_I_sym, Q_R, N, dt, t):
...
def integrateSEIRS(SEIRS, total_time, interval):
    t = 0
    for i in range(int(total_time / interval)):
        new_SEIRS = np.array(runSEIRS(*SEIRS[-1], interval, t))
        # print(new_SEIRS)
        # print(SEIRS)
...
if __name__ == '__main__':
    ...
    SEIRS = integrateSEIRS(SEIRS, day, interval)
    print(SEIRS[-1], N)
